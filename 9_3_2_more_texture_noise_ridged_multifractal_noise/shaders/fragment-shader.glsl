...
void main() {
  ...
  //classic fbm
  // float noiseSample = fbm(gridSeed, 16, 0.5, 2.0); // 3 octaves, persistance 0.5 (how quickly amplitude drops off), lacunarity 2.0 (how quickly frequency increases)
  // noiseSample = remap(noiseSample, -1.0, 1.0, 0.0, 1.0);

  //ridged fbm
  float noiseSample = ridgedFbm(gridSeed, 4, 0.5, 2.0); // 3 octaves, persistance 0.5 (how quickly amplitude drops off), lacunarity 2.0 (how quickly frequency increases)

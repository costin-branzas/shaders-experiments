...
class MainThreeJSClass {
    ...
    async init() {
        ...
        const boxGeometry = new THREE.BoxGeometry(1, 1, 1, 3, 1, 1); // increasing the tesallation so that the fragment shader has extra vertexes to run on to compute pow2 

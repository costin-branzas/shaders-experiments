...
class MainThreeJSClass {
    ...
    async init() {
        ...
        const simple4PixelTexture = textureLoader.load('./resources/simple-4-pixels.png');

        simple4PixelTexture.magFilter = THREE.NearestFilter;
        // simple4PixelTexture.magFilter = THREE.LinearFilter;
        
        // simple4PixelTexture.wrapS = THREE.ClampToEdgeWrapping;
        // simple4PixelTexture.wrapT = THREE.ClampToEdgeWrapping;

        // simple4PixelTexture.wrapS = THREE.WrapAroundEnding;
        // simple4PixelTexture.wrapT = THREE.WrapAroundEnding;

        this.material = new THREE.ShaderMaterial({
          uniforms: {
            simple4PixelTexture: {value: simple4PixelTexture},

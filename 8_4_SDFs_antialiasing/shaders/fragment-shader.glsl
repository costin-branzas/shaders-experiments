...
void main() {
  ...
  float d = sdfHexagon(pixelCoords, 400.0);
  ...
  color = mix(red, color, smoothstep(-20.0, 0.0, d)); //then reapply bright red all the way until -20 inside the circle trasitioning to the dark color defined above
